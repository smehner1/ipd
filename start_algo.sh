...
tools/collect_netflow_local.sh | /home/max/WORK/masterthesis/miniconda3/envs/mini/bin/python3 algo.py -q=0.5 -c4=0.00025 -c6=0.00025 -cidrmax4=8 -cidrmax6=8 -e=120 -t=60 -loglevel=10
